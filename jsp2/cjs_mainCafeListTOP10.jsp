...
//-----
    ...
    String WhereDefault4="(select sk.skStatus from storekeeper as sk where s.storekeeper_skSeqNo = sk.skSeqNo) as skStatus from store as s ";
    String WhereDefault5="order by likeCount desc limit 10";
    int count = 0;
