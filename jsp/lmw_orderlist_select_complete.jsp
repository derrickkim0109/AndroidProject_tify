...
//-----
    ...
    String WhereDefault = "select ol.*, o.oInsertDate, o.oStatus from tify.orderlist as ol, tify.order as o where ol.storekeeper_skSeqNo = " + skSeqNo + " and (o.oStatus = 3 or o.oStatus = 4) and o.oNo = ol.order_oNo order by ol.order_oNo desc";
    int count = 0;
