...
<%
    ...
    // 0(결제완료)인 주문 내역 => OrderRequestFragment
...
//-----
    ...
    String WhereDefault = "select * from tify.order where oStatus = 0 and store_skSeqNo = " + skSeqNo + " and oDeleteDate = null order by oNo desc";
    int count = 0;
