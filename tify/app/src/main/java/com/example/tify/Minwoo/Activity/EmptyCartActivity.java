        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) { //menu_bottom.xml에서 지정해줬던 아이디 값을 받아와서 각 아이디값마다 다른 이벤트를 발생시킵니다.//
                    case R.id.action1: {
                        Intent intent = new Intent(EmptyCartActivity.this, JiseokMainActivity.class);
                    ...
                    case R.id.action2: {
                        //주문내역
                        Intent intent = new Intent(EmptyCartActivity.this, OrderListActivity.class);
                    ...
                    case R.id.action3: {
                        Intent intent = new Intent(EmptyCartActivity.this, qrActivity.class);
                        startActivity(intent);
                        finish();
                    ...
                    case R.id.action5: {
                        //마이페이지
                        Intent intent = new Intent(EmptyCartActivity.this, MypageActivity.class);
                        startActivity(intent);
