package com.example.tify.Hyeona.Bean;
    ...
    public class Bean_main_search {
        ...
        public Bean_main_search() {
        }

        public Bean_main_search(String sName, String sTelNo, String sRunningTime, String sAddress, String sImage, String sPackaging, String sComment, String storekeeper_skSeqNo, String likeCount, String reviewCount, String skStatus) {
            this.sName = sName;
            this.sTelNo = sTelNo;
